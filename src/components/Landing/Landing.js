...
import { faMapMarkerAlt, faHeart, faHeartBroken } from '@fortawesome/free-solid-svg-icons'
        ...
        <div id='landing'>
            <div id='col1'>
                <div id='col1Content'>
                    ...
                    <div id='location'>
                        <FontAwesomeIcon icon={faMapMarkerAlt} style={{color:'#ccc'}}/>
                        <p>Atlanta, GA</p>
                    </div>
                </div>
            </div>
            <div id='col2'>
                <div id='landingContent'>
                    ...
                    <button 
                        id='likeBtn'
                        style={{cursor:'pointer',outline:'none',border:'none',backgroundColor:'rgba(0,0,0,0)'}} 
                        onClick={()=>dispatch(like())}>
                        {/* onClick={()=>setIsLiked(isLiked= !isLiked)}> */}
                        <FontAwesomeIcon icon={faHeart} style={isLiked ? {color:'red'} : {color:'gray'}}/>
